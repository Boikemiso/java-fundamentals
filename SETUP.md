# 🔧 Setup Guide - Java Fundamentals Homework

This guide walks you through setting up everything you need to complete the homework. Don't worry if you're new to this—we'll go step by step!

## What You Need

1. **Java Development Kit (JDK)** - To write and run Java code
...
You should see test output. Tests may fail (that's normal—you haven't done the exercises yet!), but Maven should run without errors.
...
3. Open the `java-fundamentals` folder
4. Start coding!
...
2. Install and open
3. Click **Open Project** → Select `java-fundamentals` folder
...
├── pom.xml
└── src/
    ├── main/java/com/fundamentals/basics/
    │   ├── DataTypeExercises.java
    │   ├── TypeCastingExercises.java
    │   ├── StringHandlingExercises.java
    │   ├── VariableScopeExercises.java
    │   ├── ConstantsAndFinalExercises.java
    │   ├── MethodSignaturesExercises.java
    │   ├── ExceptionHandlingExercises.java
    │   └── DebugMeCode.java
    └── test/java/com/fundamentals/basics/
        ├── DataTypeExercisesTest.java
        ├── TypeCastingExercisesTest.java
        ├── StringHandlingExercisesTest.java
        ├── VariableScopeExercisesTest.java
        ├── ConstantsAndFinalExercisesTest.java
        ├── MethodSignaturesExercisesTest.java
        ├── ExceptionHandlingExercisesTest.java
        └── DebugMeCodeTest.java
```
...
3. ✅ Go to README.md and start exercises!

---

**Need help?** Reach out directly. You've got this! 💪